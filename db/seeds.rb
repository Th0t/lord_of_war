...
weap_raff = Weapon.create!(title:            "Dassault Rafale",
                          ...
                          price:            215000000,
                          owner:            user_putin,
                          remote_photo_url:        "https://upload.wikimedia.org/wikipedia/commons/7/73/Rafale_-_RIAT_2012_%287852045796%29.jpg",
                          availability:     "yes")
...
weap_m134 = Weapon.create!(title:            "Gatling M134",
                          ...
                          price:            2835,
                          owner:            user_rambo,
                          remote_photo_url:        "https://upload.wikimedia.org/wikipedia/commons/e/ec/Gau_17_7.62mm_minigun.jpg",
                          availability:     "yes")
...
weap_ak47 = Weapon.create!(title:            "AK-47",
                          ...
                          price:            157,
                          owner:            user_farc,
                          remote_photo_url:        "https://upload.wikimedia.org/wikipedia/commons/1/18/AK_47.JPG",
                          availability:     "yes")
...
weap_bra5 = Weapon.create!(title:            "Browning A-5",
                          ...
                          price:            53,
                          owner:            user_gege,
                          remote_photo_url:        "https://upload.wikimedia.org/wikipedia/commons/6/6f/RemingtonMd11.JPG",
                          availability:     "yes")
...
weap_goun = Weapon.create!(title:            "no uzed goun",
                          ...
                          price:            67,
                          owner:            user_wech,
                          remote_photo_url:        "http://i.dailymail.co.uk/i/pix/2013/08/04/article-0-1B257780000005DC-975_634x463.jpg",
                          availability:     "yes")
...
weap_maul = Weapon.create!(title:            "Lightsaber",
                          ...
                          price:            17800,
                          owner:            user_maul,
                          remote_photo_url:        "https://lumiere-a.akamaihd.net/v1/images/darth-mauls-lightsaber_3c972f6c.jpeg?region=0%2C61%2C1560%2C878&width=768",
                          availability:     "yes")
...
weap_snow = Weapon.create!(title:            "Longclaw",
                          ...
                          price:            1240,
                          owner:            user_snow,
                          remote_photo_url:        "http://awoiaf.westeros.org/images/8/8b/Longclaw%2C_Sword_of_Jon_Snow.jpg",
                          availability:     "yes")
...
weap_nuke = Weapon.create!(title:            "Tsar Bomba",
                          ...
                          price:            2,
                          owner:            user_putin,
                          remote_photo_url:        "http://nuclearweaponarchive.org/Russia/TsarBomba2Big.jpg",
                          availability:     "yes")
...
weap_pen = Weapon.create!(title:            "Death pen",
                          ...
                          price:            215000000,
                          owner:            user_rambo,
                          remote_photo_url:        "https://duckduckgo.com/i/9f5837a2.jpg",
                          availability:     "yes")


Booking.create!(start_date:      "2017-03-11",
               end_date:        "2017-03-16",
               status:          "accepted",
               hirer:           user_rambo,
               weapon:          weap_nuke)
...
Booking.create!(start_date:      "2017-02-11",
               end_date:        "2017-02-12",
               status:          "rejected",
               hirer:           user_wech,
               weapon:          weap_pen)
...
Booking.create!(start_date:      "2016-11-11",
               end_date:        "2016-12-01",
               status:          "pending",
               hirer:           user_rambo,
               weapon:          weap_goun)

Booking.create!(start_date:      "2017-06-08",
               end_date:        "2017-06-10",
               status:          "pending",
               hirer:           user_putin,
               weapon:          weap_raff)

Booking.create!(start_date:      "2017-05-15",
               end_date:        "2017-05-28",
               status:          "pending",
               hirer:           user_rambo,
               weapon:          weap_m134)

Booking.create!(start_date:      "2017-01-11",
               end_date:        "2017-01-31",
               status:          "pending",
               hirer:           user_gege,
               weapon:          weap_ak47)

Booking.create!(start_date:      "2017-04-11",
               end_date:        "2017-04-28",
               status:          "pending",
               hirer:           user_farc,
               weapon:          weap_bra5)

Booking.create!(start_date:      "2017-07-01",
               end_date:        "2017-07-08",
               status:          "pending",
               hirer:           user_maul,
               weapon:          weap_m134)

Booking.create!(start_date:      "2017-08-08",
               end_date:        "2017-10-28",
               status:          "pending",
               hirer:           user_snow,
               weapon:          weap_bra5)

Booking.create!(start_date:      "2017-06-11",
               end_date:        "2017-06-22",
               status:          "pending",
               hirer:           user_putin,
               weapon:          weap_pen)

Booking.create!(start_date:      "2017-07-14",
               end_date:        "2017-07-16",
               status:          "pending",
               hirer:           user_farc,
               weapon:          weap_raff)
Booking.create!(start_date:      "2017-01-01",
               end_date:        "2017-01-28",
               status:          "pending",
               hirer:           user_snow,
               weapon:          weap_snow)
